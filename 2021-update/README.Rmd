...
states_v10  <- readRDS(here("archive/states-v10.rds"))
states_v11a <- readRDS(here("archive/states-v11a.rds"))
states_v11b <- readRDS(here("archive/states-v11b.rds"))
...
fcasts_v11a <- read_csv(here("archive/fcasts-rf-v11a.csv"), col_types = cols())
fcasts_v11b <- read_csv(here("archive/fcasts-rf-v11b.csv"), col_types = cols())
