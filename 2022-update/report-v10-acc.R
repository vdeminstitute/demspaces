...
fcasts10 <- fcasts10 %>%
  left_join(truth12, by = c("gwcode" = "gwcode", "from_year" = "year",
                            "outcome" = "outcome"))
...
pr_auc_vec(factor(fcasts10$truth_up, levels = c("1", "0")), fcasts10$p_up)
roc_auc_vec(factor(fcasts10$truth_up, levels = c("1", "0")), fcasts10$p_up)
...
write_csv(tbl, "report-data/acc-v10.csv")
