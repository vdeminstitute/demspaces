...
# 2925 update (v15): 12273, 4608 *done in 2026 for MPSA
...
# naCountFun(vdem_country_year0, 2023)
...
## # UPDATE: check the hard coded variables
...
naCountFun(vdem_dvs_longer, 2024)
