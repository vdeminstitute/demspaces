...
```
    ...
    ## # A tibble: 9 x 12
    ##   gwcode  year v2x_veracc_osp v2x_veracc_osp_… dv_v2x_veracc_o… dv_v2x_veracc_o…
    ##    <dbl> <dbl>          <dbl>            <dbl> <chr>                       <int>
    ## 1    310  2011          0.913          -0.007  same                            0
    ## 2    310  2012          0.913           0      same                            0
    ## 3    310  2013          0.907          -0.006  same                            0
    ## 4    310  2014          0.836          -0.071  same                            0
    ## 5    310  2015          0.833          -0.003  same                            0
    ## 6    310  2016          0.834           0.001  same                            0
    ## 7    310  2017          0.826          -0.008  same                            0
    ## 8    310  2018          0.753          -0.0730 same                           NA
    ## 9    310  2019          0.755           0.002  same                           NA
    ## # … with 6 more variables: dv_v2x_veracc_osp_down_next2 <int>,
    ## #   v2x_veracc_osp_up_ma5 <dbl>, v2x_veracc_osp_down_ma5 <dbl>,
    ## #   v2x_veracc_osp_up_ma10 <dbl>, v2x_veracc_osp_down_ma10 <dbl>,
