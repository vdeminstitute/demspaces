...
```
    ...
    ##  2    310  2012          0.915 same                                            0
    ##  3    310  2013          0.909 same                                            0
    ##  4    310  2014          0.818 down                                            0
    ##  5    310  2015          0.817 same                                            0
    ##  6    310  2016          0.817 same                                            0
    ##  7    310  2017          0.807 same                                            0
    ##  8    310  2018          0.755 same                                            0
    ##  9    310  2019          0.755 same                                            0
    ## 10    310  2020          0.761 same                                            0
    ## 11    310  2021          0.757 same                                            0
    ## 12    310  2022          0.758 same                                           NA
    ## 13    310  2023          0.759 same                                           NA
...
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:---|
| gwcode | 0 | 1.00 | 462.69 | 240.08 | 2.00 | 305.00 | 461.00 | 663.00 | 950.00 | ▅▆▇▇▃ |
| year | 0 | 1.00 | 1996.67 | 15.99 | 1968.00 | 1983.00 | 1997.00 | 2010.00 | 2023.00 | ▇▇▇▇▇ |
| v2x_veracc_osp | 0 | 1.00 | 0.62 | 0.27 | 0.05 | 0.41 | 0.70 | 0.89 | 0.96 | ▃▂▃▃▇ |
| dv_v2x_veracc_osp_up_next2 | 338 | 0.96 | 0.06 | 0.23 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| dv_v2x_veracc_osp_down_next2 | 338 | 0.96 | 0.04 | 0.20 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| v2xcs_ccsi | 0 | 1.00 | 0.58 | 0.32 | 0.01 | 0.27 | 0.66 | 0.89 | 0.98 | ▅▃▂▃▇ |
...
| dv_v2x_freexp_altinf_down_next2 | 338 | 0.96 | 0.06 | 0.23 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| v2x_horacc_osp | 0 | 1.00 | 0.55 | 0.31 | 0.02 | 0.25 | 0.56 | 0.85 | 0.99 | ▅▅▃▅▇ |
| dv_v2x_horacc_osp_up_next2 | 338 | 0.96 | 0.07 | 0.26 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| dv_v2x_horacc_osp_down_next2 | 338 | 0.96 | 0.05 | 0.23 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
