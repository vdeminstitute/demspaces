...
for (var_i in dv_vars) {
  ...
  # spring 2022 update. 
  use_ert_lite <- ifelse(is.null(USE_ERT_LITE), 
                         getOption("demspaces.version") >= "v12.1",
                         USE_ERT_LITE %in% TRUE)
  if (use_ert_lite) {
    cat("Using ERT-lite outcome version\n")
    dv_i <- dv_i %>%
...
```
    ...
    ##  2    310  2012          0.913 same                                            0
    ##  3    310  2013          0.908 same                                            0
    ##  4    310  2014          0.816 down                                            0
    ##  5    310  2015          0.818 same                                            0
    ##  6    310  2016          0.815 same                                            0
    ##  7    310  2017          0.809 same                                            0
    ##  8    310  2018          0.756 same                                            0
    ##  9    310  2019          0.754 same                                            0
    ## 10    310  2020          0.758 same                                            0
    ## 11    310  2021          0.755 same                                            0
    ## 12    310  2022          0.758 same                                            0
    ## 13    310  2023          0.758 same                                           NA
    ## 14    310  2024          0.757 same                                           NA
...
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:---|
| gwcode | 0 | 1.00 | 462.70 | 240.01 | 2.00 | 310.00 | 461.00 | 663.00 | 950.00 | ▅▆▇▇▃ |
| year | 0 | 1.00 | 1997.18 | 16.27 | 1968.00 | 1983.00 | 1998.00 | 2011.00 | 2024.00 | ▆▆▇▇▇ |
| v2x_veracc_osp | 0 | 1.00 | 0.62 | 0.27 | 0.05 | 0.41 | 0.70 | 0.88 | 0.96 | ▃▂▃▃▇ |
| dv_v2x_veracc_osp_up_next2 | 337 | 0.96 | 0.06 | 0.23 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| dv_v2x_veracc_osp_down_next2 | 337 | 0.96 | 0.04 | 0.20 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| v2xcs_ccsi | 0 | 1.00 | 0.57 | 0.32 | 0.01 | 0.27 | 0.66 | 0.88 | 0.98 | ▅▃▂▃▇ |
| dv_v2xcs_ccsi_up_next2 | 337 | 0.96 | 0.10 | 0.29 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| dv_v2xcs_ccsi_down_next2 | 337 | 0.96 | 0.07 | 0.25 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| v2xcl_rol | 0 | 1.00 | 0.60 | 0.30 | 0.00 | 0.35 | 0.64 | 0.88 | 0.99 | ▃▃▃▅▇ |
| dv_v2xcl_rol_up_next2 | 337 | 0.96 | 0.08 | 0.27 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| dv_v2xcl_rol_down_next2 | 337 | 0.96 | 0.05 | 0.23 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| v2x_freexp_altinf | 0 | 1.00 | 0.56 | 0.33 | 0.01 | 0.22 | 0.66 | 0.87 | 0.99 | ▆▃▂▅▇ |
| dv_v2x_freexp_altinf_up_next2 | 337 | 0.96 | 0.08 | 0.27 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| dv_v2x_freexp_altinf_down_next2 | 337 | 0.96 | 0.06 | 0.23 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| v2x_horacc_osp | 0 | 1.00 | 0.55 | 0.31 | 0.02 | 0.25 | 0.57 | 0.86 | 0.99 | ▅▅▃▅▇ |
| dv_v2x_horacc_osp_up_next2 | 337 | 0.96 | 0.08 | 0.26 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| dv_v2x_horacc_osp_down_next2 | 337 | 0.96 | 0.06 | 0.23 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| v2x_pubcorr | 0 | 1.00 | 0.53 | 0.30 | 0.01 | 0.26 | 0.50 | 0.81 | 1.00 | ▆▆▅▅▇ |
| dv_v2x_pubcorr_up_next2 | 337 | 0.96 | 0.09 | 0.29 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
| dv_v2x_pubcorr_down_next2 | 337 | 0.96 | 0.10 | 0.31 | 0.00 | 0.00 | 0.00 | 0.00 | 1.00 | ▇▁▁▁▁ |
